...
# You can switch to PostgreSQL/Supabase later by uncommenting the PostgreSQL config below
DATABASES = {
    'default': {
...
# Uncomment below for Supabase PostgreSQL (after setting up Supabase)
# DATABASES = {
#     'default': {
